          ...
          <div className="steps2-container3">
            <div className="steps2-container4 thq-card">
              <h2 className="thq-heading-2">
                {props.step1Title ?? (
                  <Fragment>
                    <span className="steps2-text29">Sign Up for Free</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text25">
                      Create your account to access all the features of our
                ...
                {props.step2Title ?? (
                  <Fragment>
                    <span className="steps2-text27">
                      Explore Flashcards and Quizzes
                    </span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text28">
                      Engage with our smart flashcards and adaptive quizzes to
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text26">
                      Take advantage of AI-generated notes and track your
                      progress to stay on top of your study goals.
                    </span>
                  </Fragment>
                )}
              </span>
